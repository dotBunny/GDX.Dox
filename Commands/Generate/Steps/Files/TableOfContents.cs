...
using System.IO;
using System.Text;
using Dox.Commands.Generate.TableOfContents;
using Dox.Utils;
...
public class TableOfContents : StepBase
{
    ...
    public override void Execute()
    {
        ...
        Dictionary<string, Entry> namespaces = new();

        // Create our roots
        Entry gdxRoot = new() { name = "GDX", items = new List<Entry>() };
        namespaces.Add(gdxRoot.name, gdxRoot);

        Entry gdxEditorRoot = new() { name = "GDX.Editor", items = new List<Entry>() };
                    ...
                    else
                    {
                        ...
                        for (int partIndex = 0; partIndex < partCount; partIndex++)
                        {
                            ...
                            else
                            {
                                ...
                                Entry newParent = new() { name = tempNamespace, uid = tempNamespace };
